...
class NewNode:
    ...
    def send_command(self, command: str = "", data: str = "", type: str = "") -> dict:
        return anedya_sendCommand(self.API_KEY, self.nodeId, command, data, type)
...
def anedya_sendCommand(apiKey, nodeId, command: str, data: str, type: str) -> dict:
    url = "https://api.anedya.io/v1/commands/send"

    now = int(time.time() * 1000)
    expiry = now + 518400000
